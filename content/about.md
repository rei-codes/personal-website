...
- Forms - [flutter_form_builder](https://pub.dev/packages/flutter_form_builder) (or [flutter_hooks](https://pub.dev/packages/hooks), [riverpod](https://pub.dev/packages/riverpod))
...
- State Management
  ...
  - [mobx](https://pub.dev/packages/mobx), [redux](https://pub.dev/packages/redux) - They are good SM solutions but I don't think they are good fit for Flutter
- Local Storage
  - [shared_preferences](https://pub.dev/packages/shared_preferences) - It's the most reliable one but I don't like its API and It's slow compared to others
  - [sqflite](https://pub.dev/packages/sqflite),.. and any other [sql packages](https://fluttergems.dev/sql-database/) (I just don't like sql much ^^")
...
- I used BitBucket for a while (at ICE Company), I don't know why people use it.
